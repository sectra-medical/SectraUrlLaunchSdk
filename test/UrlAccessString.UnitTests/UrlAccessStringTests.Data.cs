...
public static class UrlAccessStringTestsData {
    ...
    public static readonly Dictionary<string, Parameters> TestLaunchDictionary = new() {
        ...
        { "acc_no=req1^req2", new Parameters { AccessionNumber = ["req1", "req2"] } },
        { "exam_id=ex1^ex2", new Parameters { ExaminationId = ["ex1", "ex2"] } },
        ...
        { "ids7_cmds=open_ipv_window", new Parameters { Ids7Commands = ["open_ipv_window"] } },
